...
public class SwaggerConfig {
    ...
    private ApiInfo metaData() {
        ...
        Contact contact = new Contact("Lucas Duarte", "https://github.com/lucashdp", "lucashdp@outlook.com");

        return new ApiInfo("Spring Project", "Spring Rest With Swagger", "1.0", "Terms of Service: N/A", contact,
